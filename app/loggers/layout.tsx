...
export const metadata: Metadata = {
  ...
  // },
  alternates: {
    canonical: "/loggers", // Canonical for each page
    // languages: {
  ...
  openGraph: {
    ...
    url: "https://nota.straight-line.org/loggers", // URL for each page
  ...
  twitter: {
    ...
    title: "Logs of Prof. NOTA Inc.", // Title on each page
    description:
      "Hi, X People! There are some glitchy records of our events occurring in 0101 Universe...", // Description on each page
