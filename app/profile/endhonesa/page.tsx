      ...
      <div className="grid grid-cols-1 mx-auto">
          ...
          <Card>
            <article className="relative w-full h-full">
              <div className="flex justify-between gap-2 items-center">
                <Image
                  src="/images/endhonesa-dot-com-online-store.jpg"
                  alt="ENDHONESA.COM by Prof. NOTA"
                  width={1600}
                  height={900}
            ...
            <article className="relative w-full h-full p-4 md:p-8">
              ...
              <ul className="z-20 mt-4 ml-6 text-sm duration-1000 text-zinc-400 group-hover:text-zinc-200 list-decimal">
                ...
                <li className="mt-2">
                  ...
                  <ul className="list-disc">
                    <li className="mt-2 ml-4">
                      Curated trading for physical/digital products (Prof. NOTA
                      brand, sub-brands, partners) and fixed services (e.g.
                      anti-AI jacket, mind cap, seducer t-shirt, 1-hour
                      consultation, standard IP license, Bread Factory package).
                    </li>
                    <li className="mt-2 ml-4">
                      Here is the URL link to the hall:{" "}
                      <Link
        ...
        <div className="mt-4 md:mt-8 grid grid-cols-1">
          ...
          <div className="mt-4 grid grid-cols-1 gap-2">
            <PreviewReceiptButton receiptId={5} />
