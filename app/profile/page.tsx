            ...
            <div className="w-full mx-auto lg:mx-0">
              <Card>
                <article className="relative w-full h-full p-4 md:p-8">
                  ...
                  <p className="z-20 mt-4 text-sm  duration-1000 text-zinc-400 group-hover:text-zinc-200">
                    “Inc.” is short for “incorporated”, and it is the
                    abbreviation indicating that we are a corporation, which is
                    a company, or a group of people authorized to act as a
                    single entity (legally is{" "}
                    <Link
                      target="_blank"
                      href="https://prompt.straight-line.org/"
                      className="underline duration-500 hover:text-zinc-300"
                  ...
                  <p className="z-20 mt-4 text-sm  duration-1000 text-zinc-400 group-hover:text-zinc-200">
                    ...
                    . We exist in the digital realm of the Internet where the
                    laws of physics, the laws of mathematics, and the laws of
                    code are enforced one hundred percent of the time. Where we
                    can all know a priori how that enforcement will be executed.
                  </p>
                  <p className="z-20 mt-4 text-sm  duration-1000 text-zinc-400 group-hover:text-zinc-200">
                  ...
                  <p className="z-20 mt-4 text-sm  duration-1000 text-zinc-400 group-hover:text-zinc-200">
                    ...
                    certain rules that are deployed using code on the
                    blockchain. We hope that what we manage can drive various
                    revenues, and form values so that we can all enjoy the
                    benefits. From us, by us, and for us.
                  </p>
                  <p className="z-20 mt-4 text-sm  duration-1000 text-zinc-400 group-hover:text-zinc-200">
                  ...
                  <p className="z-20 mt-4 text-sm  duration-1000 text-zinc-400 group-hover:text-zinc-200">
                    ...
                    hard work, smart work, and of course, our energy and time.
                    So, expect us, and please stay alert! Beware of scams! Let's
