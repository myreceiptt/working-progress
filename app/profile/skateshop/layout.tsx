...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://nota.endhonesa.com/profile/skateshop", // URL for each page
    siteName: "Prof. NOTA's Working Progress",
    locale: "en-US",
    images: [
      {
        url: "https://nota.endhonesa.com/images/online-skateshop-in-endhonesa.jpg", // Must be an absolute URL
        width: 1920,
        height: 1080,
    ...
    videos: [
      {
        url: "https://nota.endhonesa.com/video/images/online-skateshop-in-endhonesa.mp4", // Must be an absolute URL
        width: 800,
        height: 600,
      },
    ],
  ...
  twitter: {
    ...
    images: [
      "https://nota.endhonesa.com/images/online-skateshop-in-endhonesa.jpg",
