...
export const metadata: Metadata = {
  ...
  // },
  alternates: {
    canonical: "/progresses", // Canonical for each page
    // languages: {
    //   //   Only used when billingual page provided
    //   "en-US": "/progresses/en-US",
    //   "id-ID": "/progresses/id-ID",
    // },
  },
  // formatDetection: {
  //   email: false,
  ...
  openGraph: {
    ...
    url: "https://nota.endhonesa.com/progresses", // URL for each page
...
export default function ProgressesLayout({
  children,
}: {
