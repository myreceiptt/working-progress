...
Version 4.74 progress was reached when I released an open edition NFT of artwork as part of "MY RECEIPT of ETH" collection on the Ethereum blockchain that happened simultaneously with the Last Chance for OpenSea Legacy Royalties Enforcement.   
...
Also, I will use this artwork as unrevealed artwork for any NFT collection that I will release in the future. You can use that too if you want. Okay!